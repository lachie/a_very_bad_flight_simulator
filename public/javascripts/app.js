(function() {
  ...
  words = "FISH CAT HAT RED BLUE ENNUI EGGS APPLE BANANA ORANGE MONEY";
  ...
  Player = (function(_super) {
    ...
    Player.prototype.makeAnim = function() {
      ...
      return this.anim.onAnimationEnd = function(anim, anim) {
        if (anim === 'splat') return player.finishedDying();
      };
    };
    ...
    Player.prototype.fire = function() {
      ...
      if (this.state === 'die' || this.state === 'dying') return;
      if (this.state !== event) {
        this.state = event;
        switch (this.state) {
          case 'jump':
    ...
    Player.prototype.tick = function() {
      ...
      switch (this.state) {
        ...
        case 'dying':
          ...
          if (this.y <= 0) this.finishedDying();
          break;
        default:
          accel = Gravity;
          this.flame.visible = false;
  ...
  Word = (function(_super) {
    ...
    Word.prototype.tick = function() {
      if (this.wasHit) return this.color = '#400';
    };
  ...
  Sector = (function(_super) {
    ...
    Sector.prototype.generate = function() {
      if (this.next_building_time <= 0) this.obstacle();
    ...
    Sector.prototype.obstacle = function() {
      ...
      if (this.next_building_jitter < 30) this.next_building_jitter = 30;
    ...
    Sector.prototype.remove_children = function() {
      var abs_x, child;
      if (this.getNumChildren() === 0) return;
  ...
  Game = (function(_super) {
    ...
    Game.prototype.start_game = function() {
      ...
      this.grass1.y = HEIGHT - 30;
      this.grass2.y = HEIGHT - 30;
    ...
    Game.prototype.check_sky = function() {
      ...
      if (this.sky1.x < -SKY_WIDTH) this.sky1.x += SKY_WIDTH * 2;
      if (this.sky2.x < -SKY_WIDTH) return this.sky2.x += SKY_WIDTH * 2;
    };

    Game.prototype.check_grass = function() {
      this.grass1.x -= GRASS_SPEED;
      this.grass2.x -= GRASS_SPEED;
      if (this.grass1.x < -GRASS_WIDTH) this.grass1.x += GRASS_WIDTH * 2;
      if (this.grass2.x < -GRASS_WIDTH) return this.grass2.x += GRASS_WIDTH * 2;
    };
